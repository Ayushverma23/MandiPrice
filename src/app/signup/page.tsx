...
type UserRole = 'farmer' | 'arthiya' | 'buyer'
        ...
        <div className="min-h-screen flex items-center justify-center bg-paper-cream px-4 py-12">
            <div className="w-full max-w-xl bg-white rounded-2xl shadow-xl p-8 border border-gray-100">
                <div className="text-center mb-8">
                    <Link
                        href="/"
                        className="inline-flex items-center gap-2 text-earth-green mb-6 hover:opacity-80 transition-opacity"
                    >
                    ...
                    <p className="text-gray-500 mt-2">
                        {step === 1
                            ? 'How do you want to use Khet Bazaar?'
                            : `Signing up as a ${role?.charAt(0).toUpperCase()}${role?.slice(1)}`}
                    </p>
                </div>
