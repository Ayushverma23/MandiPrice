...
export default function BuyerProfilePage() {
    ...
    const handleSubmitBank = async () => {
        ...
        setTimeout(() => {
            ...
            success("Bank details change request sent for verification.");
        }, 1500);
    };
                        ...
                        <div className="flex items-center justify-between mb-6 mt-2">
                            <div className="flex items-center gap-4">
                                ...
                                <div>
                                    ...
                                    <p className="text-sm text-gray-500">For refunds & withdrawals</p>
                                </div>
                            </div>
                        ...
                        <div className="space-y-4">
                            ...
                            <div>
                                ...
                                {isEditingBank ? (
                                    ...
                                    <p className="font-medium text-text-ink font-mono">XXXX-XXXX-1234</p>
                                )}
                            </div>
                            <div>
                                ...
                                {isEditingBank ? (
                                    ...
                                    <p className="font-medium text-text-ink font-mono">HDFC0001234</p>
                                )}
                            </div>
                            ...
                            {isEditingBank && (
                                <p className="text-xs text-gray-500 italic mt-2">
                                    * Changes to bank details require admin approval.
                                </p>
                            )}
                        </div>
                    </div>
